...
.. note::
	 ...
	 .. code-block:: bash
			...
			#install nvidia driver
                        cd ~ && wget http://us.download.nvidia.com/tesla/460.32.03/NVIDIA-Linux-x86_64-460.32.03.run
                        chmod a+x NVIDIA-Linux-x86_64-460.32.03.run
                        sudo ./NVIDIA-Linux-x86_64-460.32.03.run --accept-license --silent
...
.. Yamls for kale-jupyterlab deployment: https://github.com/CONABIO/kube_sipecam/tree/master/deployments/jupyterlab_cert/efs

...
HOSTPATH_PV_EFS=hostpath-pv-efs
HOSTPATH_PVC_EFS=hostpath-pvc-efs
JUPYTERLAB_SERVICE_HOSTPATH_PV=jupyterlab-cert-0.6.1-hostpath-pv
URL=https://raw.githubusercontent.com/CONABIO/kube_sipecam/master/minikube_sipecam/deployments/jupyterlab_cert/
```
...
wget $URL/hostpath_pv/$HOSTPATH_PV_EFS.yaml
wget $URL/hostpath_pv/$HOSTPATH_PVC_EFS.yaml
...
kubectl create -f $URL/hostpath_pv/$HOSTPATH_PV_EFS.yaml
kubectl create -f $URL/hostpath_pv/$HOSTPATH_PVC_EFS.yaml
```
